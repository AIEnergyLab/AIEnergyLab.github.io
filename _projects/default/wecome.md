...
<div class="p-4">
    ...
    <hr />
    <p>
       Our team is conducting diverse <code>AI projects</code> to advance the deployment of AI technologies to empower energy system transitions. It can be the photo of your pets, your favorite books, your favorite projects, or anything else you want to show to the world.
    </p>
    <p>
